...
@section('title', __('faq.edit_faq'))
@section('page-title', __('faq.edit_faq'))

@section('content')

    <div class="row">
        <div class="col-12">
            <form class="" action="#" method="POST" id="edit_faq_form">
                <div class="row">
                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="form-group ck-editor__editable_inlin col-12">
                                        ...
                                        <textarea id="FAQ_Answer" name="FAQ_Answer" required> {!! $faq->Faq_Answer !!}</textarea>
        ...
        $(document).ready(function() {
            ...
            function editFaq() {
                ...
                if (bodyContent == '') {
                    ...
                    $.ajax({
                        url: "{{ route('faq.update', ['id' => $faq->Faq_ID]) }}",
                        type: "POST",
                        processData: false,
                        contentType: false,
                        data: fd,
